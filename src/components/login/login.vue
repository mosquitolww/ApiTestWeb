                    ...
                    <div class="page-login--form">
                        <div class="page-login--content-footer">
                            <p class="page-login--content-footer-copyright"
                               style="font-size:26px;font-weight:700;font-family:KaiTi">测试平台
                            </p>
                        </div>
                        <el-card shadow="never">
                            <el-form ref="loginForm" label-position="top" size="default">
                                ...
                                <el-button size="default" @click.native="login()" type="primary" class="button-login">登录
                                </el-button>
                            </el-form>
                        </el-card>
                    ...
                    'password': this.password,
                        ...
                        if (response.data['status'] === 0) {
                            ...
                            if (this.token) {
                                ...
                                let redirect = decodeURIComponent(this.$route.query.redirect || '/manage/reportCharts');
