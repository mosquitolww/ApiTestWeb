    ...
    <div class="modeManage">
        <el-form :inline="true" class="demo-form-inline search-style" size="small">
            ...
            <el-form-item>
                ...
                <el-button type="primary" @click.native="initTaskData()">添加任务</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-dialog title="任务配置" :visible.sync="taskData.modelFormVisible" width="42%">
            <el-tabs>
                <el-tab-pane label="messages" style="margin-top: 10px">
                    <el-form>
                        ...
                        <el-form-item label="安全加签" :label-width="taskData.formLabelWidth"
                                      prop="desc">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary"
                           @click.native="addTask()" size="small">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
