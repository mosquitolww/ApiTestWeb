<template>
    <div class="projectManage">
        <el-form :inline="true" class="demo-form-inline search-style" size="small">
            ...
            <el-form-item>
                <el-button type="primary" icon="el-icon-search" @click.native="proHandleCurrentChange(1)">搜索</el-button>
                <el-button type="primary" @click.native="initProjectData()">添加项目</el-button>
            </el-form-item>
        </el-form>
        <el-tabs value="first" style="padding-left: 10px">
            <el-tab-pane label="项目列表" name="first" class="table_padding">
                <el-table :data="tableData" stripe max-height="725">
                    ...
                    <el-table-column prop="principal" label="负责人" width="150"></el-table-column>
        ...
        <el-dialog title="项目配置" :visible.sync="projectData.modelFormVisible" width="40%"
            ...
            <el-tabs>
                <el-tab-pane label="基础信息" style="margin-top: 10px">
                    <el-form :inline="true">
                        ...
                        <el-form-item label="负责人" label-width="60px">
                            <el-select v-model="form.user" value-key="user_id" id="user" size="mini" style="width: 100px">
                                <el-option
                    ...
                    <el-tabs v-model="environmentChoice" type="card">
                        <el-tab-pane label="环境地址" name="first">
                ...
                <el-tab-pane label="公用变量" style="margin-top: 10px">
                    ...
                    <el-button type="primary" size="mini" @click="addProjectVariable()">添加
                    </el-button>
