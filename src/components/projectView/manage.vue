        ...
        <el-container>
            <el-aside width="auto" style="min-height: 936px">
                ...
                <el-scrollbar wrap-class="specialList">
                    <el-menu :default-active="navigationName"
                        ...
                        <el-submenu index="1">
                            <template slot="title">
                                <i class="el-icon-time"></i><span>数据概览</span>
                            </template>
                            <el-menu-item-group>
                                <el-menu-item index="/manage/reportCharts">测试结果</el-menu-item>
                                <el-menu-item index="/manage/apiCharts">接口统计</el-menu-item>
                            </el-menu-item-group>
                        </el-submenu>
                        <el-submenu index="2">
                            <template slot="title">
                                <i class="el-icon-document"></i><span>接口管理</span>
                            </template>
                            <el-menu-item-group>
                        ...
                        <el-submenu index="3">
                            <template slot="title">
                                <i class="el-icon-time"></i><span>报告管理</span>
                            </template>
                            <el-menu-item-group>
