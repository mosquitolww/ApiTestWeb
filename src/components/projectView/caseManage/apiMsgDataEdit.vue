    ...
    <div class="apiMsgDataEdit"
        ...
        <el-tabs  type="card" style="margin-top: 10px">
            ...
            <el-tab-pane label="Headers" style="margin-top: 10px">
                <el-card shadow="hover"
                    ...
                    <el-button type="primary" size="mini"
                               @click="addCaseHeader()">添加</el-button>
                    <el-switch
                    ...
                    <el-table-column property="value" label="操作" header-align="center" width="80">
                        <template slot-scope="scope">
                            <el-button type="danger" icon="el-icon-delete" size="mini"
                                       @click.native="delCaseHeader(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
            <el-tab-pane label="Params" style="margin-top: 10px">
                <el-card shadow="hover"
                         :body-style=styleCard>
                    <el-button type="primary" size="mini"
                               @click="addCaseParam()">添加</el-button>
                    <el-switch
                            style="margin-left: 10px"
                ...
                <el-table :data="apiCaseData.param" size="mini" stripe>
                    ...
                    <el-table-column property="value" label="操作" header-align="center" width="80">
                        <template slot-scope="scope">
                            <el-button type="danger" icon="el-icon-delete" size="mini"
                                       @click.native="delCaseParam(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
            <el-tab-pane label="Body" style="margin-top: 10px">
                <el-card shadow="hover"
                    ...
                    <el-button type="primary" size="mini"
                               ...
                               @click="addCaseVariable()">添加</el-button>
                ...
                <el-table :data="apiCaseData.variable" size="mini" stripe
                                    ...
                                    <el-col :span="3">
                                        <el-upload
                                            ...
                                            <el-button size="mini" type="primary"
                                                       @click="tempNumTwo(scope.$index)">点击上传</el-button>
                                        </el-upload>
                                    </el-col>
                                </el-row>
                            </div>
                    ...
                    <el-table-column property="value" label="操作" header-align="center" width="80">
                        <template slot-scope="scope">
                            <el-button type="danger" icon="el-icon-delete" size="mini"
                                       @click.native="delCaseVariable(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
            <el-tab-pane label="Extract" style="margin-top: 10px">
                <el-card shadow="hover"
                         :body-style=styleCard>
                    <el-button type="primary" size="mini"
                               @click="addCaseExtract()">添加</el-button>
                    <el-switch
                            style="margin-left: 10px"
                ...
                <el-table :data="apiCaseData.extract" size="mini" stripe>
                    ...
                    <el-table-column property="value" label="操作" header-align="center" width="80">
                        <template slot-scope="scope">
                            <el-button type="danger" icon="el-icon-delete" size="mini"
                                       @click.native="delCaseExtract(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
            <el-tab-pane label="Assert" style="margin-top: 10px">
                <el-card shadow="hover"
                         :body-style=styleCard>
                    <el-button type="primary" size="mini"
                               @click="addCaseValidate()">添加</el-button>
                    <el-switch
                            style="margin-left: 10px"
                ...
                <el-table :data="apiCaseData.validate" size="mini" stripe>
                    ...
                    <el-table-column property="value" label="操作" header-align="center" width="80">
                        <template slot-scope="scope">
                            <el-button type="danger" icon="el-icon-delete" size="mini"
                                       @click.native="delCaseValidate(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
        ...
        <div slot="footer" class="dialog-footer" style="margin-top: 5px">
            ...
            <el-button type="primary"
                       @click="sureConfigBtn()" size="mini">保 存</el-button>
